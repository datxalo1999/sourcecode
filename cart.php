  ...
  <div class="content_wrapper">
	...
	<div id="content_area">	
	  ...
	  ?>
	   ...
	   <b style="color:navy">Giỏ của bạn - </b> Total Items: <?php total_items();?> Tổng cộng: <?php total_price(); ?>
   ...
   while($fetch_cart = mysqli_fetch_array($run_cart)){
       ...
       while($fetch_product = mysqli_fetch_array($result_product)){
		...
		$values = array_sum($product_price); //tinh tong cac phan tu trong mang
   ...
   ?>
	...
	<?php } } // End While  ?> 
	    ...
	    <tr align="center">
		   <td colspan="2"><input type="submit" name="update_cart" value="Cập nhật giỏ" /></td>
		   <td><input type="submit" name="continue" value="Tiếp tục mua" /></td>
		   <td><button><a href="checkout.php">Thủ tục thanh toán</a></td>
		</tr>
	   </table>
	   </form>
